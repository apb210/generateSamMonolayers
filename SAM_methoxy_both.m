...
apratim = strcat('sam_OCH3_both','.gro');
fid = fopen(apratim,'W');
...
for ap=1:(nrows2/(natoms+1))
    ...
    for c = ap + 1:ap+natoms
        ...
        ctr5 = ctr5 + 1;
         if (ctr5==11)
            ...
            fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
            ,'RS1',strcat('O'),ctr4,xx(ctr,1),xx(ctr,2),xx(ctr,3));
            
        else
            if (ctr5==12)
                fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
                ,'RS1',strcat('C',num2str(ctr5-1)),ctr4,xx(ctr,1),xx(ctr,2),xx(ctr,3));
            else
                fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
                ,'RS1',strcat('C',num2str(ctr5)),ctr4,xx(ctr,1),xx(ctr,2),xx(ctr,3));
            end
  ...
  fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
      ,'RS1','HC11',ctr4+1,xx(nrows2+ctr3+1,1),...
      xx(nrows2+ctr3+1,2),xx(nrows2+ctr3+1,3));
  fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
      ,'RS1','HC11',ctr4+2,xx(nrows2+ctr3+2,1),...
      xx(nrows2+ctr3+2,2),xx(nrows2+ctr3+2,3));
  fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
      ,'RS1','HC11',ctr4+3,xx(nrows2+ctr3+3,1),...
  ...
  ctr4=ctr4+3;  
    ...
    %    ctr4=ctr4+1;
    %  fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
    %    ,'RS1',strcat('C',num2str(ctr5)),ctr4,xx(ctr,1),xx(ctr,2),-xx(ctr,3)+2*offsetz);
    %    
    %end
     ...
     for c = ap + 1:ap+natoms
        ...
        ctr5 = ctr5 + 1;
         if (ctr5==11)
            ...
            fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
            ,'RS1',strcat('O'),ctr4,xx(ctr,1),...
            -xx(ctr,2)+translate*sqrt(3)*lconst,-xx(ctr,3)+2*offsetz);
            
        else
            if (ctr5==12)
                fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
                ,'RS1',strcat('C',num2str(ctr5-1)),ctr4,xx(ctr,1),-xx(ctr,2)+translate*sqrt(3)*lconst,-xx(ctr,3)+2*offsetz);
            else
                fprintf(fid,'%5d%5s%5s%5d%8.3f%8.3f%8.3f\n',ap...
                ,'RS1',strcat('C',num2str(ctr5)),ctr4,xx(ctr,1),-xx(ctr,2)+translate*sqrt(3)*lconst,-xx(ctr,3)+2*offsetz);
            end
